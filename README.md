...
## 🧑‍💻 Experience
- **멋쟁이사자처럼 13기 아기사자** (2025)
- **멋쟁이사자처럼 14기 운영진 (트랙장)** (2026)
- **컴퓨터공학부 전공** (2022 ~ )
...
| :--- | :--- | :--- | :--- |
| **25.12 ~ 26.02**<br>**Career-HI** | **📊 AI 맞춤형 취업 리포트 제공**<br>사용자 이력 데이터 기반 커리어 분석 및 멀티 모듈 아키텍처 구축 | **Backend Lead**<br>Spring Boot, MariaDB<br>OCI, OpenAI API | [📂 GitHub](https://github.com/syu-HackathonTeam/career-hi-back) |
| **25.11 ~ 26.02**<br>**멋쟁이사자처럼 홈페이지**<br>*(14기 공식 LMS)* | **🦁 동아리 전용 통합 LMS 및 커뮤니티**<br>이중 권한(RBAC) 검증 아키텍처 및 Multipart 복합 처리 API 구축 | **Backend Lead**<br>Spring Boot, Spring Security<br>MySQL, OCI | [📂 GitHub](https://github.com/GyoseungKu/Likelion_SYU_Homepage) |
...
## 🚀 Featured Project: [SafePath]
> **"우리는 단순한 지도 앱이 아닙니다. 학부모를 위한 '안전 컨설턴트'입니다."**

**1. 🎯 문제 정의 (The Gap)**
- **Plan A의 실패:** 맞벌이 등 현실적인 이유로 자녀와 24시간 동행할 수 없는 부모들의 불안감.
- **기존 서비스의 한계:** 네이버지도/카카오는 '최단 거리(효율)'만 강조하여 '안전'에 대한 니즈를 무시함.

**2. 💡 솔루션 (Safety Report)**
- **Safe Scoring Engine:** 공공 데이터(CCTV, 경찰서, 가로등, 24시 편의점)를 분석하여 경로별 안전 점수 산출.
- **AI Consulting:** Upstage AI(LLM)를 활용해 "B경로는 2분 더 걸리지만 CCTV가 7개 더 많아 안전합니다"라는 전문 리포트 제공.
